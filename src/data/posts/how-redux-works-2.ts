...
<p>Now you might remember from <a href="__GHOST_URL__/how-redux-works/"><a href="__GHOST_URL__/how-redux-works/">part </a>one</a> that we have the notion of a store enhancer. These wrap the store and can modify it's exported functions. In this case, <code>applyMiddleware</code> is a store enhancer that wraps <code>dispatch</code>.</p>
<p>So when we create our store, we pass <code>applyMiddleware</code> with a middleware as the second argument.</p>
<!--kg-card-begin: html-->
<script src="https://gist.github.com/matthew-gerstman/398b682e6c20d20e426e9334f01a3dec.js"></script>
<!--kg-card-end: html-->
<p>This second argument triggers the following block from <code>createStore</code>:</p>
<!--kg-card-begin: html-->
<script src="https://gist.github.com/matthew-gerstman/9388c9b6dd4c167424a05c6b72a49168.js"></script>
<!--kg-card-end: html-->
...
<!--kg-card-begin: html-->
<script src="https://gist.github.com/matthew-gerstman/79fa2ae4cb62e6594c50193fef69d00b.js"></script>
<!--kg-card-end: html-->
...
<p>As an aside, the process of returning functions that each require a single argument is called currying. You can read more about that in <a href="__GHOST_URL__/functional-programming-fundamentals/">Functional Programming Fundamentals</a>.</p>
...
<!--kg-card-begin: html-->
<script src="https://gist.github.com/matthew-gerstman/5c27fe5e7f0ddb7df39052b88eb982ba.js"></script>
<!--kg-card-end: html-->
<p>The first thing it does is, surprise, calls <code>createStore</code> with these arguments. Then it temporarily overwrites <code>dispatch</code> to make sure our consumers don't accidentally call it while we're setting up the store. This pattern should look familiar from <a href="__GHOST_URL__/how-redux-works/"><a href="__GHOST_URL__/how-redux-works/">part </a>one</a>, we're validating before doing business logic.</p>
<p>Okay now let's look at the entire function.</p>
<!--kg-card-begin: html-->
<script src="https://gist.github.com/matthew-gerstman/8d79f0ff97192a91bea13f8534aa5b3a.js"></script>
<!--kg-card-end: html-->
...
<!--kg-card-begin: html-->
<script src="https://gist.github.com/matthew-gerstman/4860c96843b35db2438c52767fa230a5.js"></script>
<!--kg-card-end: html-->
<p>Wow, thats a dense 14 lines of code, and once again it's functions all the way down. Now might be a good time to refresh on <a href="__GHOST_URL__/functional-programming-fundamentals/">currying</a>. Let's step through this line by line.</p>
...
<!--kg-card-begin: html-->
<script src="https://gist.github.com/matthew-gerstman/c8468374cb8a814f9dbf7b7b2cce1436.js"></script>
<!--kg-card-end: html-->
...
<!--kg-card-begin: html-->
<script src="https://gist.github.com/matthew-gerstman/e139975425a5f190461c20c6b671650e.js"></script>
<!--kg-card-end: html-->
...
<!--kg-card-begin: html-->
<script src="https://gist.github.com/matthew-gerstman/d10b5bdb1aa3ea0ef0854e29749404e2.js"></script>
<!--kg-card-end: html-->
...
<!--kg-card-begin: html-->
<script src="https://gist.github.com/matthew-gerstman/5855b7de59a79fe4f59036bf9d2b10e2.js"></script>
<!--kg-card-end: html-->
...
<!--kg-card-begin: html-->
<script src="https://gist.github.com/matthew-gerstman/191b00ffe4f3e2a052f762285bbe6e68.js"></script>
<!--kg-card-end: html-->
...
<!--kg-card-begin: html-->
<script src="https://gist.github.com/matthew-gerstman/c7239957990bb935ec15f811d369d490.js"></script>
<!--kg-card-end: html-->
...
<!--kg-card-begin: html-->
<script src="https://gist.github.com/matthew-gerstman/56f2164f455995a358e022491aed7845.js"></script>
<!--kg-card-end: html-->
...
<!--kg-card-begin: html-->
<script src="https://gist.github.com/matthew-gerstman/ec4d29d127c357c12e3a66286a3daa94.js"></script>
<!--kg-card-end: html-->
...
<!--kg-card-begin: html-->
<script src="https://gist.github.com/matthew-gerstman/3c30a9214369f63cc99643e137fc161f.js"></script>
<!--kg-card-end: html-->
<p>This is a big function but the bulk of the logic is right here.</p>
<!--kg-card-begin: html-->
<script src="https://gist.github.com/matthew-gerstman/0119aa89e891b33f7c2489d554b5e59d.js"></script>
<!--kg-card-end: html-->
...
<!--kg-card-begin: html-->
<script src="https://gist.github.com/matthew-gerstman/176fa2cd86bc6edc34d4720ac1cf8b5c.js"></script>
<!--kg-card-end: html-->
