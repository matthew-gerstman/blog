...
<p>The one thing we skip in this article is <a href="__GHOST_URL__/mary-had-a-little-lambda/">lambda calculus</a>, check out <a href="__GHOST_URL__/mary-had-a-little-lambda/">Mary Had a Little Lambda</a> for more on that. I also have an article called <a href="__GHOST_URL__/map-filter-reduce/">Map, Filter, Reduce</a> that is more practical.</p>
